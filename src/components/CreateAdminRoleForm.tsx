...
const adminRoleSchema = z.object({
    role_name: z.string().min(3, "Tên vai trò phải có ít nhất 3 ký tự"),
    level:z.number({
    }).min(1,"Level phải từ 1 đến 10, trong đó 1 là cấp cao nhất").max(10,"Level phải từ 1 đến 10, trong đó 10 là cấp thấp nhất").int("Level phải là số nguyên")
});
